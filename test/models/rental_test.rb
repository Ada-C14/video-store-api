...
describe Rental do
  describe "relations" do
    ...
    it "must respond to videos" do
      ...
      expect(rental_1).must_respond_to :video
      expect(rental_1.video).must_be_kind_of Video
    end

    it "must respond to customers" do
      rental_1 = rentals(:rental_1)
      expect(rental_1).must_respond_to :customer
      expect(rental_1.customer).must_be_kind_of Customer
    end
